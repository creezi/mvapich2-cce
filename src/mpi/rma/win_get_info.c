...
/* TICKET_271: add new get_info routine for window object */
...
/*@
   MPI_Win_get_info - Get the MPI Info object associated with the window object
...
#   endif /* HAVE_ERROR_CHECKING */
    ...
    mpi_errno = MPIU_Info_dup((*win_ptr)->info_ptr, &info_ptr);
    if (mpi_errno != MPI_SUCCESS) goto fn_fail;
...
#   ifdef HAVE_ERROR_CHECKING
	...
	mpi_errno = MPIR_Err_create_code(
	    mpi_errno, MPIR_ERR_RECOVERABLE, FCNAME, __LINE__, MPI_ERR_OTHER, "**mpi_win_get_info", 
	    "**mpi_win_get_info %W %p", win, info);
    }
#   endif
