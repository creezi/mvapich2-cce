...
/* TICKET_271: Add new dup_with_info routine */
/* TODO: have MPI_Comm_dup delegate its work to this where it passes existing info */
...
int MPIR_Comm_dup_with_info_impl(MPID_Comm *comm_ptr, MPID_Info* newinfo_ptr, MPID_Comm **newcomm_ptr)
{
    ...
    */
    ...
    /* TICKET_271: process hints set by user and combine with defaults
...
Notes:
  ...
  'MPI_Comm_dup_with_info' operations on this communicator.
